...
export const layout = tv({
    slots: {
        background: "bg-white dark:bg-[#0C0F14]",
        FeedCard:
            "flex items-center w-full h-[80px] justify-between select-none cursor-pointer bg-white text-black dark:bg-[#0C0F14] dark:text-white",
    },
    variants: {
        page: {
            single: {
