...
export const linkcard = tv({
    slots: {
        LinkCard:
            "md:h-[100px] h-[80px] w-full rounded-lg overflow-hidden border md:hover:border-gray-600 flex items-center text-gray-800 bg-white text-black md:hover:bg-[#DBDBDB] border-[#E8E8E8] md:dark:hover:bg-[#1C1C1C] dark:border-[#181818] dark:bg-transparent",
        LinkCardThumbnailContainer:
            "md:h-[100px] h-[80px] md:w-[100px] w-[80px] border-r md:hover:border-gray-600 border-[#E8E8E8] dark:border-[#181818]",
