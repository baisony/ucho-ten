...
export const viewSideBar = tv({
    slots: {
        ...
        AuthorIconContainer:
            "md:h-[100px] h-[80px] border-b-[1px] border-[#E3E3E3] pl-[18px] flex items-center cursor-pointer",
        AuthorDisplayName: "font-black font-[16px]",
        AuthorHandle: "",
        Content:
            "md:h-[calc(100%-100px-200px)] h-[calc(100%-80px-200px)] pl-[18px] pt-[24px] pb-[24px] ",
