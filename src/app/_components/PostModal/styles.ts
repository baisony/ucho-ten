...
export const postModal = tv({
    slots: {
        ...
        PostModal:
            "text-white dark:text-[#D7D7D7] bg-[#DADADA] dark:bg-[#0C0F14] bg-opacity-70 backdrop-blur-[15px] dark:bg-opacity-50 dark:backdrop-blur-[15px] w-full min-w-[300px] max-w-[600px] h-[350px] shadow-xl relative rounded-none md:rounded-[10px] md:overflow-hidden md:min-h-[400px]",
