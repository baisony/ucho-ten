...
export const viewPostCard = tv({
    slots: {
        ...
        PostAuthorIcon: "h-[30px] w-[30px] object-cover hover:cursor-pointer",
        ...
        PostReactionButton:
            "md:h-[16px] h-[14px] md:pl-[8px] pl-[6px] md:pr-[8px] pr-[6px] md:ml-[60px] ml-[45px] text-[10px] text-[#909090] dark:text-[#636363] cursor-pointer select-none",
        dropdown: "",
