...
export const searchTabPage = tv({
    slots: {
        ...
        Container:
            "min-w-[350px] max-w-[500px] w-full h-full text-white relative",
        RecommendContainer: "fixed bottom-[50px]",
        FeedCard:
            "w-full h-[75px] bg-white border-t-[0.5px] border-b-[0.5px] flex items-center",
        FeedCardIcon:
            "h-[50px] w-[50px] bg-[#D9D9D9] rounded-[10px] ml-[40px] mr-[10px]",
