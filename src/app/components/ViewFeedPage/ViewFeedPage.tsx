...
export const ViewFeedPage: React.FC<Props> = (props: Props) => {
    const { className, color, isMobile, isProfileMine, isSubscribe, isPinned } =
        props
    const reg =
        /^[\u0009-\u000d\u001c-\u0020\u11a3-\u11a7\u1680\u180e\u2000-\u200f\u202f\u205f\u2060\u3000\u3164\ufeff\u034f\u2028\u2029\u202a-\u202e\u2061-\u2063\ufeff]*$/
            ...
            <div className={ProfileContainer({ color: color })}>
                <div className={ProfileInfoContainer()}>
                    <img
                        ...
                        src={
                            "https://av-cdn.bsky.app/img/avatar/plain/did:plc:txandrhc7afdozk6a2itgltm/bafkreihwad5kaujw2f6kbfg37zmkhclgd3ap7grixl6pusfb5b34s6jite@jpeg"
                        }
                    ></img>
                    <div className={Buttons()}>
                        ...
                        <div className={ProfileActionButton()}>
                            <FontAwesomeIcon
                                icon={faThumbTack}
                                className={PinButton({ isPinned: isPinned })}
                            />
                        </div>
                        <Button
                    ...
                    <div className={ProfileHandle({ isMobile: isMobile })}>
                        created by @bisn.ucho-ten.net
                    </div>
