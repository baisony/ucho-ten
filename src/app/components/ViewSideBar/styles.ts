...
export const viewSideBar = tv({
    slots: {
        ...
        AuthorIconContainer:
            "h-[15%] max-h-[100px] w-full border-b-[1px] border-[#E3E3E3] pl-[18px] bg-white bg-opacity-40 flex items-center cursor-pointer",
        AuthorDisplayName: "font-black font-[16px]",
        AuthorHandle: "",
        Content:
            "h-[60%] w-full pl-[18px] pt-[24px] pb-[24px] bg-white bg-opacity-40",
