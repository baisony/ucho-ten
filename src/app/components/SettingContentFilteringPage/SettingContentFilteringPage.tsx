...
export const SettingContentFilteringPage: React.FC<Props> = (props: Props) => {
    ...
    const { background, table } = settingContentFilteringPage()
            ...
            >
                ...
                <TableBody>
                    ...
                    <TableRow key="7">
                        ...
                        <TableCell>
                            <Switch
                                defaultSelected={isImpersonation}
                                aria-label="Automatic updates"
                            />
                        </TableCell>
                    </TableRow>
