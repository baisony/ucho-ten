        ...
        <main className={Container({ color: color })}>
            <div className={AuthorPost()}>
                ...
                <div className={PostContent()}>
                    ...
                    {translateError && (
                        <div className={"text-red-500"}>Translation error</div>
                    )}
                ...
                <div className={PostCreatedAt()}>2021-09-01 12:00:00</div>
                <div className={ReactionButtonContainer()}>
                    ...
                    ></FontAwesomeIcon>
                    <FontAwesomeIcon
                        icon={!isLiked ? faRegularSquare : faSolidSquare}
                        className={ReactionButton()}
                    ></FontAwesomeIcon>
                    <FontAwesomeIcon
                        icon={
                            !isBookmarked ? faRegularBookmark : faSolidBookmark
                        }
                        className={ReactionButton()}
                    ></FontAwesomeIcon>
